...
const createOfferedCourseIntoDB = async (payload: TOfferedCourse) => {
    ...
    if (!isDepartmentBelongToFaculty) {
        throw new AppError(httpStatus.BAD_REQUEST, `This ${isAcademicDepartmentExist.name} is not belongs to this ${isAcademicFacultyExist.name}`);
    }
    ...
    if(isSameOfferedCourseExistsWithSameRegisterWithSameSection) {
        throw new AppError(httpStatus.CONFLICT, 'Offered course with same section is already exists.');
    }
